...
process_read = os.popen("ps -ef | grep run.py | grep -v 'grep'").readlines()
...
text_location = check_process.find("run.py")
# run24h.py가 몇번째 문자열인지 찾아낸다. 만약 문자열이 없으면, 즉 프로세스가 존재하지 않을 경우에는 -1을 반환한다.
if (text_location == -1):
    print("Process not found!")
    os.system("python3 /home/ec2-user/workspace/mago-demo-api-healthcare/run.py &")
